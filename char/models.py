...
class Char(models.Model):
    ...
    class_field = models.PositiveSmallIntegerField(choices=JOBS,
                                                   db_column='class',
                                                   help_text='Não altere manualmente, use comandos do jogo.')  # Campo renomeado porque era uma palavra reservada do Python.
    ...
    def preview_image_link(self):
        ...
        #se o token foi renovado, mas houve um erro de qualquer maneira, retorne None
    ...
    def preview_image(self):
        ...
        # Alguns avatares estão quebrados, se 404 tente a assinatura do char
